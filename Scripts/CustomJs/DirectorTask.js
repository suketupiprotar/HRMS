            ...
            "columns": [
                ...
                },
                {
                    ...
                    "render": function (data, type, row) {
                        ...
                        return '<button class="btn btn-success gap-3 directorTaskCreateOrUpdate" data-id="' + row.TaskId + '">Edit</button>' +
...
$(document).on("click", ".directorTaskCreateOrUpdate", function () {
    var id = $(this).data("id");
    $.ajax({
        type: "GET",
        url: "/Director/TaskCreate/" + id,
...
$(document).on("click", ".deleteButton", function () {
    ...
    $.ajax({
        type: "GET",
        url: "/Director/DirectorTaskDelete/" + id,
        success: function (response) {
            if (response.success) {
